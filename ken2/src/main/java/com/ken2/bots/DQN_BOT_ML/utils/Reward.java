...
public class Reward {
    ...
    /**
     * Checks if the current player created at least two rows of five chips.
     *
     * @param state         The current game state.
     * @param currentColor  The current player's color ("white" or "black").
     * @return {@code true} if the player has at least two rows of five chips; {@code false} otherwise.
     */
    ...
    /**
     * Checks if the player has created a line of a specified length.
     *
     * @param state         The current game state.
     * @param prevState     The previous game state.
     * @param length        The length of the line to check for.
     * @param currentColor  The current player's color ("white" or "black").
     * @return {@code true} if the player created a line of the specified length; {@code false} otherwise.
     */
    ...
    /**
     * Determines if the opponent created a line of chips during the move.
     *
     * @param previousState The game state before the move.
     * @param newState      The game state after the move.
     * @param currentColor  The current player's color ("white" or "black").
     * @return {@code true} if the opponent's 3-chip line count increased; {@code false} otherwise.
     */
