package com.ken2.bots.MLABbot;

import com.ken2.Game_Components.Board.*;
import com.ken2.bots.AlphaBetaBot.AlphaBetaResult;
...
//        HashMap<Vertex, ArrayList<Move>> validMoves = vertexMove;
    ...
    private GameState moveState(GameState state, Move move) {
        ...
        Bot thisBot = new com.ken2.bots.AlphaBetaBot.AlphaBetaBot(thisBotColor);
        Bot opponentBot = new com.ken2.bots.AlphaBetaBot.AlphaBetaBot(thisBotColor.toLowerCase().equals("white")?"black":"white");
